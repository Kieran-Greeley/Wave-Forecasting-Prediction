...
Instructions
1. Merge the Data
    Run the following script to merge the data files: python MergeData.py

2. Preprocess the Data
    After merging, preprocess the data using: python preprocess.py

3. Run Regression Analysis
    Finally, perform the regression analysis: python Regression.py
